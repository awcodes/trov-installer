...
namespace Trov\Installer\Console\Tests;

use Trov\Installer\Console\NewCommand;
...
{
    public function test_it_can_scaffold_a_new_trov_app()
    {
        ...
        $app = new Application('Trov Installer');
