...
class NewCommand extends Command
{
    ...
    protected function configure()
    {
        $this
            ->setName('new')
            ->setDescription('Create a new Trov application')
  ...
  |______\__,_|_|  \__,_| \_/ \___|_|</>'.PHP_EOL.PHP_EOL);
        ...
        if (($process = $this->runCommands($commands, $input, $output))->isSuccessful()) {
            ...
            $this->installFilament($directory, (bool) $input->getOption('dark'), $input, $output);
     ...
     * @return void
     */
    protected function installFilament(string $directory, $dark, InputInterface $input, OutputInterface $output)
    {
        chdir($directory);

        $commands = array_filter([
            $this->findComposer().' require filament/filament',
            PHP_BINARY.' artisan vendor:publish --tag=filament-config',
